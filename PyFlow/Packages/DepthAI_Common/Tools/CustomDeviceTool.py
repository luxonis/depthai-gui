...
class Second(QMainWindow):
    def __init__(self):
        ...
        self.nameLabel.setText("TEST" + "Device name")
        ...
        self.colorLabel.setText("TEST" + "Color cameras")
        ...
        self.monoLabel.setText("TEST" + "Mono cameras")
        ...
        self.leftfovLabel.setText("TEST" + "Left FOV deg.")
        ...
        self.rightfovLabel.setText("TEST" + "Right FOV deg.")
        ...
        self.rgbfovLabel.setText("TEST" + "RGB FOV deg.")
        ...
        self.lrdistanceLabel.setText("TEST" + "Left - Right distance cm.")
        ...
        self.lrgbdistanceLabel.setText("TEST" + "Left - RGB distance cm.")
