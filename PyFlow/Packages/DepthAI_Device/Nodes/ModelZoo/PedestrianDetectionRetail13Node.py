...
class PedestrianDetectionRetail13Node(DeviceNode):
    ...
    def build_pipeline(self, pipeline):
        ...
        detection_nn.setBlobPath(str(Path(str((Path(__file__).parent / Path('models/person-detection-retail-0013.blob')).resolve().absolute())).resolve().absolute()))
