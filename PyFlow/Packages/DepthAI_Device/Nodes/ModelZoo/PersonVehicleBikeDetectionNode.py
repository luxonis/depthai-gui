...
class PersonVehicleBikeDetectionNode(DeviceNode):
    ...
    def build_pipeline(self, pipeline):
        ...
        detection_nn.setBlobPath(str(Path(str((Path(__file__).parent / Path('models/person-vehicle-bike-detection-crossroad-1016.blob')).resolve().absolute())).resolve().absolute()))
