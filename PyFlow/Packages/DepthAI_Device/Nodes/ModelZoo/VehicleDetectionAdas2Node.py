...
class VehicleDetectionAdas2Node(DeviceNode):
    ...
    def build_pipeline(self, pipeline):
        ...
        detection_nn.setBlobPath(str(Path(str((Path(__file__).parent / Path('models/vehicle-detection-adas-0002.blob')).resolve().absolute())).resolve().absolute()))
